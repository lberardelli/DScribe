...
import ca.mcgill.cs.swevo.dscribe.annotations.DScribeAnnotations.ReturnNull;
...
public class FocalTestPairFactory {
     ...
     *
     * @param focalClassName the name of the focal class for which to instantiate a FocalTestPair instance
     * @return the instantiated FocalTestPair instance if able to resolve the class name. Null otherwise.
     * @dscribe Returns null when ClassDNE
     */
